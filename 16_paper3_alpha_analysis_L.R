...
# 设置结果保存目录
RESULTS_DIR <- PAPER3_RESULTS_DIR
...
# 启动日志记录
log_file <- file.path(LOGS_DIR, paste0("16_paper3_alpha_L_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
...
cat("15. 生成分析报告\n")
cat("========================================================\n")
report_file <- file.path(LOGS_DIR, "16_paper3_report_L.txt")
sink(report_file)
...
# ============================================================================
cat("16. 保存会话信息...\n")
session_info_path <- file.path(LOGS_DIR, "16_session_info_L.txt")
...
code_list_path <- file.path(LOGS_DIR, "16_code_list_L.txt")
