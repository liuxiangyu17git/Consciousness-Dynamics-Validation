...
# 启动日志记录（期刊要求）
log_file <- file.path(LOGS_DIR, paste0("12_paper2_L_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
...
# ============================================================================
cat("10. 生成分析报告...\n")
report_file <- file.path(LOGS_DIR, "12_paper2_report_L.txt")
sink(report_file)
...
# ============================================================================
cat("11. 保存会话信息...\n")
session_info_path <- file.path(LOGS_DIR, "12_session_info_L.txt")
...
code_list_path <- file.path(LOGS_DIR, "12_code_list_L.txt")
