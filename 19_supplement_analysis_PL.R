...
# 设置结果保存目录
RESULTS_DIR <- SUPPLEMENT_RESULTS_DIR
...
# 日志
log_file <- file.path(LOGS_DIR, paste0("19_supplement_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
...
alpha_file <- file.path(PAPER3_RESULTS_DIR, "eTable4.csv")
...
sink(file.path(LOGS_DIR, "19_supplement_report.txt"))
...
# ============================================================================
cat("\n10. 保存会话信息...\n")
session_info_path <- file.path(LOGS_DIR, "19_session_info.txt")
...
code_list_path <- file.path(LOGS_DIR, "19_code_list.txt")
