...
# 启动日志记录（期刊要求）
log_file <- file.path(LOGS_DIR, paste0("15_paper2_deep_cont_P_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
...
cat("5. 保存会话信息...\n")
cat("========================================================\n")
session_info_path <- file.path(LOGS_DIR, "15_session_info_P.txt")
...
code_list_path <- file.path(LOGS_DIR, "15_code_list_P.txt")
