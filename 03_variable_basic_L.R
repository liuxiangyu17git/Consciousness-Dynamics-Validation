...
# 启动日志记录（期刊要求）
log_file <- file.path(LOGS_DIR, paste0("03_variable_basic_L_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
...
# ============================================================================
cat("\n6. 生成NHANES教程合规报告...\n")
report_file <- file.path(LOGS_DIR, "03_variable_basic_report_L.txt")
sink(report_file)
...
# ============================================================================
cat("\n7. 保存会话信息...\n")
session_info_path <- file.path(LOGS_DIR, "03_session_info_L.txt")
...
code_list_path <- file.path(LOGS_DIR, "03_code_list_L.txt")
...
sink()
# 清理临时变量
rm(list = setdiff(ls(), c("clean_dir", "LOGS_DIR", "design_objects")))
gc()
